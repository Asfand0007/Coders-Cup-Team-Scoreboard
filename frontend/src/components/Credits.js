...
export default function Credits() {
    return (
        <div className="group relative m-1 flex justify-center">
            ...
            <span className="vsm:w-56 w-48 absolute bottom-10 left-5 scale-0 rounded-lg border-4 border-black/10 bg-black/10 p-4 vsm:text-s text-xs text-[#d6d6d6] group-hover:scale-100 backdrop-blur-md shadow-sm">
